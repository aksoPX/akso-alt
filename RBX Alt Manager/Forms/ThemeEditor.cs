...
namespace RBX_Alt_Manager.Forms
{
    public partial class ThemeEditor : Form
    {
        ...
        public static void LoadTheme()
        {
            ...
            if (!Theme.Exists("AksoStyleVersion"))
            {
                Theme.Set("AksoStyleVersion", "2");
                Theme.Set("AccountsBG", "#0B1220");
                Theme.Set("AccountsFG", "#E5E7EB");
                Theme.Set("ButtonsBG", "#2563EB");
                Theme.Set("ButtonsFG", "#FFFFFF");
                Theme.Set("ButtonsBC", "#1D4ED8");
                Theme.Set("ButtonStyle", "Flat");
                Theme.Set("FormsBG", "#0F172A");
                Theme.Set("FormsFG", "#E2E8F0");
                Theme.Set("DarkTopBar", "True");
                Theme.Set("LightImages", "True");
                Theme.Set("LabelsTransparent", "True");
                Theme.Set("ShowHeaders", "True");
                Theme.Set("TextBoxesBG", "#111827");
                Theme.Set("TextBoxesFG", "#E5E7EB");
                Theme.Set("TextBoxesBC", "#334155");
                Theme.Set("LabelsBC", "#0F172A");
                Theme.Set("LabelsFC", "#E2E8F0");
        ...
        private void ToggleDarkTopBar_Click(object sender, EventArgs e)
        {
            ...
            SaveTheme();
            MessageBox.Show("Для этой настройки нужен перезапуск akso alt.\nНа старых версиях Windows может не работать.\nВключено: " + (UseDarkTopBar ? "Да" : "Нет"), RussianLocalization.AppName, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}